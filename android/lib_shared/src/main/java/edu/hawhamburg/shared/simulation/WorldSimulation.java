...
public class WorldSimulation {
    ...
    public WorldSimulation(int markerAmount, int obstacleAmount){
        ...
        //HARDCODED KONFIGURATION DES SPIELFELDES
        //IN KONFIGDATEI // OPTIONSMENÜ ERSTELLEN
